...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Onam 2026 — Kongu Engineering College",
      },
      {
        property: "og:description",
        content:
          "Tradition. Togetherness. Triumph. Join the Onam 2026 celebrations at KEC.",
      },
      {
        property: "og:type",
        content: "website",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-6 py-16 md:px-8 md:py-24 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            ...
            <h1 className="font-display mt-1 text-5xl leading-none font-black tracking-tight text-primary md:text-7xl">
              ONAM 2026
              <span className="ml-2 align-super text-2xl text-accent">
                ✦
              </span>
            </h1>
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-muted-foreground">
              Join us for a vibrant Onam celebration filled with cultural
              events, exciting competitions and unforgettable memories.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 md:px-8 md:py-16">
        <SectionTitle
          title="Our Events"
          subtitle="Participate, Enjoy and Celebrate!"
        />
